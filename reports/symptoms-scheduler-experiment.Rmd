...
`r scales::comma(total_observations, big.mark = ".")` observations registered in both experiments. Table below shows totla numbers per device. 
...
kable(summaries,
      format = "html",
      booktabs = TRUE,
      caption = "Descriptive data per device.") %>%
