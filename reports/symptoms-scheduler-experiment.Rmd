...
outliers_BQ_bubblechart <- 
    ...
    theme_minimal() +
    labs(title= paste0("Count of (ALL) outliers grouped by hour (N=", n_outliers_BQ, ")"))
...
outliers_pos_BQ_bubblechart <- 
    ...
    scale_x_date(breaks = scales::date_breaks("1 day"),
                 labels = scales::date_format("%d-%m", tz="CET")) +
    theme_minimal() +
    labs(title= paste0("Count of outliers (POS) grouped by hour (N=", n_outliers_pos_BQ, ")"))
...
outliers_neg_BQ_bubblechart <- 
    ...
    scale_x_date(breaks = scales::date_breaks("1 day"),
                 labels = scales::date_format("%d-%m", tz="CET")) +
    theme_minimal() +
    labs(title= paste0("Count of outliers (NEG) grouped by hour (N=", n_outliers_neg_BQ, ")"))
...
outliers_H9_bubblechart <- 
    ...
    scale_x_date(breaks = scales::date_breaks("1 day"),
                 labels = scales::date_format("%d-%m", tz="CET")) +
    theme_minimal() +
    labs(title= paste0("Count of (ALL) outliers grouped by hour (N=", n_outliers_H9, ")"))
...
outliers_pos_H9_bubblechart <- 
    ...
    scale_x_date(breaks = scales::date_breaks("1 day"),
                 labels = scales::date_format("%d-%m", tz="CET")) +
    theme_minimal() +
    labs(title= paste0("Count of outliers (POS) grouped by hour (N=", n_outliers_pos_H9, ")"))
...
outliers_neg_H9_bubblechart <- 
    ...
    scale_x_date(breaks = scales::date_breaks("1 day"),
                 labels = scales::date_format("%d-%m", tz="CET")) +
    theme_minimal() +
    labs(title= paste0("Count of outliers (NEG) grouped by hour (N=", n_outliers_neg_H9, ")"))
...
outliers_MO_bubblechart <- 
    ...
    scale_x_date(breaks = scales::date_breaks("1 day"),
                 labels = scales::date_format("%d-%m", tz="CET")) +
    theme_minimal() +
    labs(title= paste0("Count of (ALL) outliers grouped by hour (N=", n_outliers_MO, ")"))
...
outliers_pos_MO_bubblechart <- 
    ...
    scale_x_date(breaks = scales::date_breaks("1 day"),
                 labels = scales::date_format("%d-%m", tz="CET")) +
    theme_minimal() +
    labs(title= paste0("Count of outliers (POS) grouped by hour (N=", n_outliers_pos_MO, ")"))
...
outliers_neg_MO_bubblechart <- 
    ...
    scale_x_date(breaks = scales::date_breaks("1 day"),
                 labels = scales::date_format("%d-%m", tz="CET")) +
    theme_minimal() +
    labs(title= paste0("Count of outliers (NEG) grouped by hour (N=", n_outliers_neg_MO, ")"))
